...
class AmazonKerasClassifier:
    ...
    def train_model_aug(self, x_train, y_train, learn_rate=0.001, epoch=5, batch_size=128, validation_split_size=0.15, train_callbacks=()):
        history = LossHistory()
        ...
        self.classifier.fit_generator(datagen.flow(X_train, y_train, batch_size=32),
